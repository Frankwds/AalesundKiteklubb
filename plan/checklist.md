...
- [x] **Tab: Spot guide** — DataTable with season/area filters; "Ny spot" dialog; edit/delete row actions *(spot admin CMS — server actions implemented in Phase 6: `createSpot`, `updateSpot`, `deleteSpot`)*
